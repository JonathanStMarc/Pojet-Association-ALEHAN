...
BtnAS.addEventListener("click", function () {
    ...
    pDetail.classList.add("border", "border-danger", "border-3", "rounded-4");
});
...
btnAI.addEventListener("click", function () {
    ...
    pDetail.classList.add("border", "border-success", "border-3", "rounded-4");
});
...
btnAP.addEventListener("click", function () {
    ...
    pDetail.classList.add("border", "border-info", "border-3", "rounded-4");
});
